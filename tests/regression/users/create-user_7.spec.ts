...
describe("User Suite", () => {
    it("@TEST_ID-3022 - Create a new user successfully", async () => {
    ...
    it("@TEST_ID-3023 - Unsuccessful creation of user, due to missing email field in the payload", async () => {
    ...
    it("@TEST_ID-3024 - Unsuccessful creation of user, with no payload", async () => {
        const data: any = {};
