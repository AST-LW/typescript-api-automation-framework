...
describe("User Suite", () => {
    it("@TEST_ID-9888 - Create a new user successfully", async () => {
    ...
    it("@TEST_ID-8888 - Unsuccessful creation of user, due to missing email field in the payload", async () => {
    ...
    it("@TEST_ID-7777 - Unsuccessful creation of user, with no payload", async () => {
        const data: any = {};
