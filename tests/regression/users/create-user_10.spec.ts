...
describe("User Suite", () => {
    it("@TEST_ID-6666 - Create a new user successfully", async () => {
    ...
    it("@TEST_ID-6655 - Unsuccessful creation of user, due to missing email field in the payload", async () => {
    ...
    it("@TEST_ID-6644 - Unsuccessful creation of user, with no payload", async () => {
        const data: any = {};
