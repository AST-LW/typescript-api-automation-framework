...
describe("User Suite", () => {
    it("@TEST_ID-1401 - Create a new user successfully", async () => {
    ...
    it("@TEST_ID-1402 - Unsuccessful creation of user, due to missing email field in the payload", async () => {
    ...
    it("@TEST_ID-1403 - Unsuccessful creation of user, with no payload", async () => {
        const data: any = {};
