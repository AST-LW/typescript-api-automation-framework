...
describe("User Suite", () => {
    it("@TEST_ID-4332 - Create a new user successfully", async () => {
    ...
    it("@TEST_ID-5566 - Unsuccessful creation of user, due to missing email field in the payload", async () => {
    ...
    it("@TEST_ID-4455 - Unsuccessful creation of user, with no payload", async () => {
        const data: any = {};
