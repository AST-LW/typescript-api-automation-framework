...
describe("User Suite", () => {
    it("@TEST_ID-1304 - Create a new user successfully", async () => {
    ...
    it("@TEST_ID-1305 - Unsuccessful creation of user, due to missing email field in the payload", async () => {
    ...
    it("@TEST_ID-1306 - Unsuccessful creation of user, with no payload", async () => {
        const data: any = {};
