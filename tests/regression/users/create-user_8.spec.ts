...
describe("User Suite", () => {
    it("@TEST_ID-4021 - Create a new user successfully", async () => {
    ...
    it("@TEST_ID-4022 - Unsuccessful creation of user, due to missing email field in the payload", async () => {
    ...
    it("@TEST_ID-4033 - Unsuccessful creation of user, with no payload", async () => {
        const data: any = {};
