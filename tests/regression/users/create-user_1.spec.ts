...
describe("User Suite", () => {
    it("@TEST_ID-1301 - Create a new user successfully", async () => {
    ...
    it("@TEST_ID-1302 - Unsuccessful creation of user, due to missing email field in the payload", async () => {
    ...
    it("@TEST_ID-1303 - Unsuccessful creation of user, with no payload", async () => {
        const data: any = {};
