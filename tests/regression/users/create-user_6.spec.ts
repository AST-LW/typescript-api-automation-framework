...
describe("User Suite", () => {
    it("@TEST_ID-2011 - Create a new user successfully", async () => {
    ...
    it("@TEST_ID-2012 - Unsuccessful creation of user, due to missing email field in the payload", async () => {
    ...
    it("@TEST_ID-2013 - Unsuccessful creation of user, with no payload", async () => {
        const data: any = {};
